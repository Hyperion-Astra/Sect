...
const Account = () => {
  ...
  return (
    <div className="market-page">
      {/* Overdue Account Recovery Services Section */}
      ...
      <section className="market-content-section">
        <div data-aos="fade-right" className="market-image-container">
          <img src="./legal.webp" alt="Overdue Account Recovery Services" className="market-image" />
          <Link to="/application">
        ...
        <div data-aos="fade-left" className="market-details">
          ...
          <div className="key-features">
            ...
            <ul>
              ...
              <li>
                <strong>Customized Recovery Plans:</strong> Our experts develop personalized strategies that align with your business goals and customer relationships.
              </li>
              <li>
                <strong>Legal Support:</strong> With a strong legal foundation, we ensure compliance with regulations while pursuing collections, protecting your interests throughout the process.
              </li>
              <li>
                <strong>Negotiation and Mediation:</strong> We engage in effective communication with debtors, aiming for amicable resolutions that facilitate timely payments.
              </li>
              <li>
                <strong>Ongoing Monitoring:</strong> Our team provides continuous follow-up and support, ensuring that recovery efforts remain on track.
              </li>
            </ul>
            <p>
              Partner with us to regain control over your finances and improve your overdue account recovery rates. Let us help you turn challenges into opportunities for growth.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="market-content-section">
        <div data-aos="fade-right" className="market-image-container">
          <img src="./legal.webp" alt="Accounting & Bookkeeping Services" className="market-image" />
          <Link to="/application">
            <button className="request-button">Request for our Services</button>
          </Link>
        </div>
        <div data-aos="fade-left" className="market-details">
          ...
          <div className="key-features">
            ...
            <ul>
              ...
              <li>
                <strong>Tax Compliance:</strong> We handle all aspects of tax preparation and filing, ensuring compliance with current regulations while maximizing deductions and minimizing liabilities.
              </li>
              <li>
                <strong>Budgeting and Forecasting:</strong> We assist in creating budgets and financial forecasts, helping you plan for the future and make informed business decisions.
              </li>
              <li>
                <strong>Tailored Solutions:</strong> Our services are customized to meet the unique needs of your business, whether you’re a small startup or a larger enterprise.
              </li>
            </ul>
            <p>
